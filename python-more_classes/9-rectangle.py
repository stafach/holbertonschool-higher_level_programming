...
class Rectangle:
    ...
    def __str__(self):
        ...
        for i in range(0, self.__height):
            for j in range(0, self.__width):
                rectangle_p += str(self.print_symbol)
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Compare two rectangle and give the bigger one
        ...
        Raises:
            TypeError: If rect_1 or rect_2 aren't Rectangle
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): The size of width and height of the square (default 0).
